const command = {
    command: ['menu', 'menú', 'help', 'cmd', 'cmds', 'comandos', 'funciones'],
    categoria: ['main']
}
...
╰╶╴──────╶╴─╶╴◯`
    ...
    await conn.sendMessage(m.chat.id, { document: Buffer.alloc(5), fileName: 'KAZE AI', mimetype: 'image/jpeg', jpegThumbnail: image, caption: menu, contextInfo: { mentionedJid: [m.sender.id], externalAdReply: { title: author, body: desc, thumbnail: mylogo, renderLargerThumbnail: true, showAdAttribution: true, sourceUrl: CanalZp, mediaType: 1, } } })
    
    await conn.sendMessage(m.chat.id, { audio: { url: "https://www.dropbox.com/scl/fi/uaxrkff7y9gdbi8pmbp79/.mp3?rlkey=kgsjhxyififevvlcbqphzkwcx&st=5n6jqea7&dl=1" }, mimetype: 'audio/ogg; codecs=opus', contextInfo: { externalAdReply: { ptt: true, title: `ただ声一つ - Rokudenashi / ロクデナシ - AI cover`, body: `Powered by @Syllkom`, previewType: 'PHOTO', thumbnail: mylogo, mediaType: 1, renderLargerThumbnail: true, showAdAttribution: true, sourceUrl: CanalZp }}}, { quoted: m })
